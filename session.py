...
from carbonscore import get_distance_km, get_heater_carbon, get_heater_sources, get_heater_surface, get_time_hours
...
class Session:
    ...
    def get_callback(self) -> Optional[Callable[[str], None]]:
        ...
        if self.redmeal_count is None:
            return self.get_redmeal_count
    ...
    def get_redmeal_count(self, msg: str):
        ...
    ...
    @property
    def meal_emission(self): # /semaine
        return self.redmeal_count*518 if self.redmeal_count else None
    ...
    def total(self): # gCO2/an
        return round(self.car_emission*52 + self.heating_emission + self.screen_emission*365.25 + self.meal_emission*52 + self.clothes_emission*12)
